/**
 * copy from org.eclipse.osgi.framework.internal.reliablefile.ReliableFileInputStream
 */
...
/**
 * A ReliableFile FileInputStream replacement class. This class can be used just like FileInputStream. The class is in
 * partnership with ReliableFileOutputStream to avoid losing file data by using multiple files.
 * 
...
public class ReliableFileInputStream extends FilterInputStream {
    ...
    /**
     * Constructs a new ReliableFileInputStream on the file named <code>name</code>. If the file does not exist, the
     * <code>FileNotFoundException</code> is thrown. The <code>name</code> may be absolute or relative to the System
    ...
    /**
     * Constructs a new ReliableFileInputStream on the File <code>file</code>. If the file does not exist, the
