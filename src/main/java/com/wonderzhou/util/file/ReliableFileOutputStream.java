/**
 * copy from org.eclipse.osgi.framework.internal.reliablefile.ReliableFileOutputStream
 */
...
/**
 * A ReliableFile FileOutputStream replacement class. This class can be used just like FileOutputStream. The class is in
 * partnership with ReliableFileInputStream to avoid losing file data by using multiple files.
 * 
...
public class ReliableFileOutputStream extends FilterOutputStream {
    ...
    /**
     * Constructs a new ReliableFileOutputStream on the File <code>file</code>. If the file exists, it is written over.
     * See the constructor which can append to the file if so desired.
     * 
    ...
    /**
     * Constructs a new ReliableFileOutputStream on the file named <code>name</code>. If the file exists, it is written
     * over. See the constructor which can append to the file if so desired. The <code>name</code> may be absolute or
     * relative to the System property <code>"user.dir"</code>.
     * 
    ...
    /**
     * Constructs a new ReliableFileOutputStream on the file named <code>name</code>. The <code>name</code> may be
