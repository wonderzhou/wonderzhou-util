package com.wonderzhou.util.mapper;
...
public class JsonMapper {
  ...
  /**
   * 当JSON里只含有Bean的部分属性时，更新一个已存在Bean，只覆蓋该部分的属性.
   */
  ...
  /**
   * 設定是否使用Enum的toString函数来读写Enum, 为False时使用Enum的name()函数来读写Enum, 默认为False. 注意本函数一定要在Mapper创建后, 所有的读写动作之前调用.
   */
